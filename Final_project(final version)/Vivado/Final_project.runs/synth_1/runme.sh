...
HD_PWD='O:/ENGS 31/Final_project(final version)/Vivado/Final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProject_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FinalProject_shell.tcl
