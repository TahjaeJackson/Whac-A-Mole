...
HD_PWD='O:/ENGS 31/Final_project(final version)/Vivado/Final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FinalProject_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FinalProject_shell.tcl -notrace
